...
You need a specific version of nightly Rust (nightly-2023-11-23) for Rudra development.
...
export RUDRA_RUST_CHANNEL=nightly-2023-11-23
...
```
cd ..
git clone https://github.com/rust-lang/rust.git rust-nightly-2023-11-23
cd rust-nightly-2023-11-23
...
```
{
    "rust-analyzer.rustcSource": "<your path to rust-nightly-2023-11-23>/Cargo.toml"
}
```
